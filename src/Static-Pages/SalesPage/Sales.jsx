      ...
      <div className={styles.main__products}>
        <div className={styles.products_area}>
          <div className={styles.all__main__products}>
            <Link to={`/Sale/123213`} className={"rounded-xl shadow-2xl p-1"}>
              <div className={styles.each_product} >
                <div>
                  ...
                  <img src={imgError} className={"rounded-2xl shadow-2xl h-[325px]"} alt="product_img" />
                </div>
            ...
            {products?.map((item) => (
              <Link to={`/Sale/${item._id}`} className={"rounded-xl shadow-2xl p-1"}>
                <div key={item._id} className={styles.each_product}>
                  <div>
                    <div className={styles.wishlist}>
                      <AiOutlineHeart />
                    </div>
                    <img src={item.images[0].url} className={"rounded-2xl shadow-2xl "} alt="product_img" />
                  </div>
