    ...
    <div className={styles.main_register}>
      <div className={styles.register_existing}>
        <div className={styles.existing_user}>
          <form action="" className={styles.existing_content_register}>
            <h4>Đăng ký</h4>
            ...
            <div className={styles.register_social_links}>
              <a href="./" className={styles.register_btn_fb}>
                <img src={facebook} alt="facebook_logo" />
                Facebook
              </a>
              <a href="./" className={styles.register_btn_email}>
                <img src={google} alt="google_logo" />
                Google
              </a>
            </div>
            <div>
              ...
              <a href="/Login" className={styles.forget_password}>
                Đăng nhập
              </a>
            </div>
          </form>
        ...
        <div className={styles.new_user}>
          <div className={styles.new_register_content}>
            <form action="" className={styles.existing_register}>
              <input
                type="text"
                name="hoten"
                placeholder="Nhập Họ Tên"
                className={styles.ip_register_ht}
              />
              <input
                type="email"
                name="email"
                placeholder="Email"
                className={styles.ip_register_email}
              />
              <input
                type="password"
                name="password"
                placeholder="Mật khẩu"
                className={styles.ip_register_password}
              />
              <button className={styles.sing_register_button}>Đăng nhập</button>
            </form>
          </div>
        </div>
      </div>
